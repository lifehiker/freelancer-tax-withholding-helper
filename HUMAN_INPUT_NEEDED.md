...
- `AUTH_GOOGLE_ID`, `AUTH_GOOGLE_SECRET`: Optional, but required to enable Google OAuth sign-in. Without them, email/password auth remains available and the Google button is hidden.
